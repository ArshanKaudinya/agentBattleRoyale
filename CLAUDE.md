...
- `llm/` — Provider orchestration + per-model wrappers (openai.js, anthropic.js, google.js, openai-mini.js)
...
- Agent IDs: `gpt`, `claude`, `gemini`, `mini` — these map to provider functions in `llm/provider.js`

## Environment variables
- `OPENAI_API_KEY` — used by both gpt (gpt-4o) and mini (gpt-4o-mini)
- `ANTHROPIC_API_KEY` — used by claude (claude-sonnet-4)
- `GOOGLE_API_KEY` — used by gemini (gemini-2.0-flash)
